...
function analyzeDirectLink(url) {
    return new Promise((resolve)=>{
        try {
            ...
            const child = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawn"])(ffprobePath, [
                "-v",
                "error",
                "-show_format",
                "-show_streams",
...
async function POST(req) {
    ...
    return new Promise((resolve)=>{
        try {
            ...
            const child = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$child_process__$5b$external$5d$__$28$child_process$2c$__cjs$29$__["spawn"])("python", [
                ytDlpPath,
                "--js-runtimes",
                "node",
                "-f",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ugksr7._.js.map